                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency Multimodal Design & Canvas Synthesis operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark Multimodal Design Skill executed successfully."})
                    }
                ]
            }
        }
